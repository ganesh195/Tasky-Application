        ...
        <div class='card shadow-sm task_card'>
            ...
            <div class='card-body'>
                ${
                    ...
                    : `<img width='100%' src= "" alt='Card Image' class='card-img-top md-3 rounded-lg' />`
                }

                <h4 class='card-title task_card_title' >
                    ${title}
                </h4>
    ...
    return `
        <div id=${id}> 
            ${
                url
                ? `<img width='100%' src=${url} alt='Card Image' class='card-img-top md-3 rounded-lg'  /> `
                : `<img width= '100%' src= " " alt= '' class= 'card-img-top md-3 rounded-lg' />`
            }
...
const handleSubmit = (event) => {
    ...
    if (input.title === "" || input.type === "" || input.description === "") {
        return alert("Please fill all the necessary fieldsS");
    }
